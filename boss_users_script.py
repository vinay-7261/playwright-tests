...
def run_test(url):
    with sync_playwright() as p:
        ...
        page.wait_for_timeout(3000)
        page.locator("body > div > div > div.h-full > div > div > div.max-w-md.mx-auto.bg-white.md\:max-w-none.md\:shadow-none.md\:rounded-none.md\:bg-gray-50 > div.p-6.md\:p-0.md\:max-w-7xl.md\:mx-auto.md\:w-full.md\:py-4.md\:bg-gray-50 > div > div:nth-child(3) > div").scroll_into_view_if_needed()
